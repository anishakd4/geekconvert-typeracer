...
const ArrowButton = ({ children, className }: ArrowButtonProps) => {
  ...
  if (correctlyTyped > 11) {
    return null;
  }
  return (
    <div className={className}>
      <div className="relative overflow-y-clip w-32 flex justify-end">
        <div className="px-6 h-8 bg-green-500 grid place-items-center rounded-l-md text-white text-sm">
          {children}
        </div>
